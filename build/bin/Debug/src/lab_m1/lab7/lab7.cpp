...
void Lab7::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(1, 0, 1));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int object_colour = glGetUniformLocation(shader->program, "object_color");
    glUniform3fv(object_colour, 1, glm::value_ptr(color));
