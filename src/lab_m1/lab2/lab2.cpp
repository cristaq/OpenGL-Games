...
void Lab2::Init()
{
...

    {
        ...
        {
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            ...
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), 
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
        ...
        meshes["tetragon"] = new Mesh("generated tetragon 2");
        meshes["tetragon"]->InitFromData(vertices, indices);
...
void Lab2::CreateMesh(const char *name, const std::vector<VertexFormat> &vertices, const std::vector<unsigned int> &indices)
{
    ...
    unsigned int IBO = 0;
    // TODO(student): Create the IBO and bind itk
    glGenBuffers(1, &IBO);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(0.25f));
    // TODO(student): Draw the square
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(2, 2, 2), glm::vec3(0.25f));
    // TODO(student): Disable face culling
    RenderMesh(meshes["tetragon"], shaders["VertexColor"], glm::vec3(3, 3, 3), glm::vec3(0.25f));
